...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this instanceof EntityPlayerSP)
                UwU.INSTANCE.getEventManager().call(safeWalkEvent);
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                if(isPlayer) {
                    UwU.INSTANCE.getEventManager().call(new PostStepEvent((float) (this.getEntityBoundingBox().minY - this.posY)));
                }
            }
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            ...
            UwU.INSTANCE.getEventManager().call(strafeEvent);
    ...
    public double getDistance(Vec3 vec3)
    {
        double d0 = this.posX - vec3.xCoord;
        double d1 = this.posY - vec3.yCoord;
        double d2 = this.posZ - vec3.zCoord;
        return MathHelper.sqrt_double(d0 * d0 + d1 * d1 + d2 * d2);
    }
