...
import wtf.uwu.features.modules.impl.movement.NoFluid;
import wtf.uwu.features.modules.impl.visual.Animations;
import wtf.uwu.features.modules.impl.visual.Rotation;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    public final Map<Integer, PotionEffect> activePotionsMap = Maps.newHashMap();
    ...
    public void onEntityUpdate()
    {
        ...
        UwU.INSTANCE.getEventManager().call(new EntityUpdateEvent(this));
    }
    ...
    public int getArmSwingAnimationEnd() {
        if (UwU.INSTANCE.getModuleManager().getModule(Animations.class).isEnabled() && this == Minecraft.getMinecraft().thePlayer) {
            return (int) (6 + UwU.INSTANCE.getModuleManager().getModule(Animations.class).getSlowdown().get());
        } else {
    ...
    protected void jump()
    {
        ...
        UwU.INSTANCE.getEventManager().call(jumpEvent);
        ...
        UwU.INSTANCE.getEventManager().call(afterJumpEvent);
    }
    ...
    public void moveEntityWithHeading(float strafe, float forward)
    {
        ...
        UwU.INSTANCE.getEventManager().call(event);

        if(event.isCancelled())
            return;
        if (this.isServerWorld())
        {
            if (!(this.isInWater() && !UwU.INSTANCE.getModuleManager().getModule(NoFluid.class).shouldCancel) || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                if (!(this.isInLava() && !UwU.INSTANCE.getModuleManager().getModule(NoFluid.class).shouldCancel) || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                    float f4 = 0.91F;
                    ...
                    if(this instanceof EntityPlayerSP) {
                        ...
                        UwU.INSTANCE.getEventManager().call(moveEvent);
    ...
    public void onUpdate()
    {
        ...
        {
            //f1 = this.rotationYaw;
            f1 = RotationUtils.shouldRotate() && this ==  Minecraft.getMinecraft().thePlayer && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).realistic.get() ? RotationUtils.currentRotation[0] : this.rotationYaw;
        }
    ...
    protected float updateDistance(float p_110146_1_, float p_110146_2_)
    {
        ...
        if (this instanceof EntityPlayerSP) {
            if (RotationUtils.shouldRotate() && this ==  Minecraft.getMinecraft().thePlayer && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).body.get()) {
        ...
        if(RotationUtils.shouldRotate() && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).isEnabled() && !UwU.INSTANCE.getModuleManager().getModule(Rotation.class).realistic.get())
            f1 = 0;
    ...
    public void onLivingUpdate()
    {
        ...
        else if (this.isServerWorld())
        {
            ...
            this.rotationYawHead = RotationUtils.shouldRotate() && this ==  Minecraft.getMinecraft().thePlayer && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Rotation.class).realistic.get() ? RotationUtils.currentRotation[0] : this.rotationYawHead;
            this.worldObj.theProfiler.endSection();
        }
    ...
    public Vec3 getLook(float partialTicks) {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            ...
            UwU.INSTANCE.getEventManager().call(lookEvent);
