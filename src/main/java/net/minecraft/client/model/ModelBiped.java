...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if(UwU.INSTANCE.getModuleManager().getModule(KillAura.class).isHoldingSword() && UwU.INSTANCE.getModuleManager().getModule(KillAura.class).renderBlocking && entityIn == Minecraft.getMinecraft().thePlayer){
        ...
        Animations animation = UwU.INSTANCE.getModuleManager().getModule(Animations.class);
