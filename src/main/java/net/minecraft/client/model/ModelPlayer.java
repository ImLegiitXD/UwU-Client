...
public class ModelPlayer extends ModelBiped
{
    ...
    {
        Interface cape = UwU.INSTANCE.getModuleManager().getModule(Interface.class);
        if(cape.wavey.get())
            return;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (UwU.INSTANCE.getModuleManager().getModule(ESP.class).shouldDrawSkeletons() && UwU.INSTANCE.getModuleManager().getModule(ESP.class).isValid(entityIn))
            UwU.INSTANCE.getModuleManager().getModule(ESP.class).addEntity((EntityPlayer) entityIn, this);
        else if(UwU.INSTANCE.getModuleManager().getModule(ESP.class).playerRotationMap.containsKey(entityIn))
            UwU.INSTANCE.getModuleManager().getModule(ESP.class).playerRotationMap.remove(entityIn,this);
    }
