...
import wtf.uwu.UwU;
import wtf.uwu.features.modules.impl.combat.TickBase;
...
import wtf.uwu.utils.player.MovementInputFromKeyboard;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void runGameLoop() throws IOException
    {
        ...
        TickBase tickBase = UwU.INSTANCE.getModuleManager().getModule(TickBase.class);
    ...
    public void runTick() throws IOException
    {
        ...
        UwU.INSTANCE.getEventManager().call(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        UwU.INSTANCE.getEventManager().call(new KeyPressEvent(k));
                        if (k == 1)
                        {
            ...
            if (this.thePlayer.isUsingItem())
            {
                ...
                while (this.gameSettings.keyBindAttack.isPressed()) {
                    if (UwU.INSTANCE.getModuleManager().getModule(Animations.class).isEnabled() &&
                            UwU.INSTANCE.getModuleManager().getModule(Animations.class).getSwingWhileUsingItem().get()) {
