...
import wtf.uwu.features.modules.impl.visual.AspectRatio;
import wtf.uwu.features.modules.impl.visual.Atmosphere;
import wtf.uwu.features.modules.impl.visual.Camera;
import wtf.uwu.features.modules.impl.visual.FreeLook;
import wtf.uwu.gui.mainmenu.GuiMainMenu;
...
import wtf.uwu.utils.render.shader.impl.Sky;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
            if (UwU.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Camera.class).setting.isEnabled("No Hurt Cam"))
                return;
    ...
    private void setupViewBobbing(float partialTicks) {
        ...
        if (UwU.INSTANCE.getModuleManager().getModule(LongJump.class).isEnabled() &&
                UwU.INSTANCE.getModuleManager().getModule(LongJump.class).noBob.get())
            return;

        if (UwU.INSTANCE.getModuleManager().getModule(Speed.class).isEnabled() &&
                UwU.INSTANCE.getModuleManager().getModule(Speed.class).noBob.get())
            return;
    ...
    {
        Entity entity = this.mc.getRenderViewEntity();
        Camera camera = UwU.INSTANCE.getModuleManager().getModule(Camera.class);
        FreeLook freeLook = UwU.INSTANCE.getModuleManager().getModule(FreeLook.class);
        ...
        {
            double d3 = UwU.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled()? UwU.INSTANCE.getModuleManager().getModule(Camera.class).cameraDistance.get():4.0;
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        float aspect = UwU.INSTANCE.getModuleManager().getModule(AspectRatio.class).isEnabled() ? UwU.INSTANCE.getModuleManager().getModule(AspectRatio.class).aspect.get() :(float)this.mc.displayWidth / (float)this.mc.displayHeight;
        ...
        if (this.mc.gameSettings.viewBobbing && !UwU.INSTANCE.getModuleManager().getModule(Camera.class).canMinimalBobbing()) {
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    Atmosphere atmosphere = UwU.INSTANCE.getModuleManager().getModule(Atmosphere.class);
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    if (UwU.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Camera.class).setting.isEnabled("World Bloom")) {
                        UwU.INSTANCE.getModuleManager().getModule(Camera.class).drawWorldBloom();
                    }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (UwU.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Camera.class).setting.isEnabled("Shader Sky")){
            Sky.draw(UwU.INSTANCE.getStartTime());
        }
        ...
        if ((Config.isSkyEnabled() || Config.isSunMoonEnabled() || Config.isStarsEnabled()) && !Shaders.isShadowPass)
        {
            ...
            if (UwU.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled() && !UwU.INSTANCE.getModuleManager().getModule(Camera.class).setting.isEnabled("Shader Sky") || !UwU.INSTANCE.getModuleManager().getModule(Camera.class).isEnabled()) {
        ...
        UwU.INSTANCE.getEventManager().call(new Render3DEvent(partialTicks,new ScaledResolution(mc)));
