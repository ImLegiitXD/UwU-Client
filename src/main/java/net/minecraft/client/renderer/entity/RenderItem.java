...
import wtf.uwu.UwU;
import wtf.uwu.features.modules.impl.visual.EnchantGlint;
    ...
    private void renderEffect(IBakedModel model)
    {
        if (!Config.isCustomItems() || CustomItems.isUseGlint())
        {
            if (!Config.isShaders() || !Shaders.isShadowPass)
            {
                ...
                EnchantGlint enchantGlint  = UwU.INSTANCE.getModuleManager().getModule(EnchantGlint.class);
                int color = enchantGlint.isEnabled() ? enchantGlint.syncColor.get() ? UwU.INSTANCE.getModuleManager().getModule(Interface.class).color(0) : enchantGlint.color.get().getRGB() : -8372020;
