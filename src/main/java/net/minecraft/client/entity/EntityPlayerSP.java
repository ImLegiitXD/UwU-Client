...
import wtf.uwu.features.modules.impl.combat.AutoGap;
import wtf.uwu.features.modules.impl.combat.KillAura;
import wtf.uwu.features.modules.impl.exploit.Disabler;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            UwU.INSTANCE.getEventManager().call(postTickEvent);
    ...
    public void onUpdateWalkingPlayer() {
        ...
        UwU.INSTANCE.getEventManager().call(motionEvent);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (UwU.INSTANCE.getModuleManager().getModule(Disabler.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Disabler.class).options.isEnabled("GrimAC") && UwU.INSTANCE.getModuleManager().getModule(Disabler.class).grim.isEnabled("Post")) {
                UwU.INSTANCE.getModuleManager().getModule(Disabler.class).processPackets();
            }
        ...
        UwU.INSTANCE.getEventManager().call(new MotionEvent(MotionEvent.State.POST));
    }
    ...
    {
        UwU.INSTANCE.getEventManager().call(UpdateEvent.INSTANCE);
        ...
        if ((this.isUsingItem() || UwU.INSTANCE.getModuleManager().getModule(KillAura.class).target != null && UwU.INSTANCE.getModuleManager().getModule(KillAura.class).slow.get() &&
                UwU.INSTANCE.getModuleManager().getModule(KillAura.class).shouldBlock() && UwU.INSTANCE.getModuleManager().getModule(KillAura.class).isBlocking ||
                UwU.INSTANCE.getModuleManager().getModule(AutoGap.class).eating
        ) && !this.isRiding()) {
            SlowDownEvent slowDownEvent = new SlowDownEvent(0.2F, 0.2F,isSprinting());
            UwU.INSTANCE.getEventManager().call(slowDownEvent);
