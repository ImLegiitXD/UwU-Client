...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        ...
        if (this.visible)
        {
            ...
            if(UwU.INSTANCE.getModuleManager().getModule(Interface.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Interface.class).newButton.get()){
                GLUtils.startBlend();
                final int outlineColour = UwU.INSTANCE.getModuleManager().getModule(Interface.class).color();
                final int backgroundColour = this.enabled ? 0x800E0E0E : 0x80070707;
                final int textColour = this.enabled ? this.hovered ? UwU.INSTANCE.getModuleManager().getModule(Interface.class).color() : 0xFFFFFFFF : 0xFF878787;
