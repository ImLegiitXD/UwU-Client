...
import wtf.uwu.features.modules.impl.player.InvManager;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    {
        Stealer stealer = UwU.INSTANCE.getModuleManager().getModule(Stealer.class);
        ...
        InvManager invManager = UwU.INSTANCE.getModuleManager().getModule(InvManager.class);
        ...
        if (mouseButton == 0) {
            for (GuiButton guibutton : this.buttonList) {
                if (guibutton.mousePressed(this.mc, mouseX, mouseY)) {
                    ...
                    switch (guibutton.id) {
                        case 1001:
                            final KillAura killAura = UwU.INSTANCE.getModuleManager().getModule(KillAura.class);

                            if (killAura.isEnabled()) killAura.toggle();
                            break;
                        case 1002:
                            final InvManager invManager = UwU.INSTANCE.getModuleManager().getModule(InvManager.class);

                            if (invManager.isEnabled()) invManager.toggle();
                            break;
                        case 1003:
                            final Stealer stealer = UwU.INSTANCE.getModuleManager().getModule(Stealer.class);
