...
public class FontRenderer {
    ...
    public final int drawStringNoFormat(String str, float x, float y, int color, boolean darken) {
        ...
        str = str.replace("▬", "=");
       // if (UwU.INSTANCE.getModuleManager().getModule(NameHider.class) != null && UwU.INSTANCE.getModuleManager().getModule(NameHider.class).isEnabled()) {
           // str = UwU.INSTANCE.getModuleManager().getModule(NameHider.class).getFakeName(str);
        //}
        y = y - 2;
        x *= 2;
        y *= 2;
    ...
    public final int getStringWidth(String text) {
        ...
        //if (UwU.INSTANCE.getModuleManager().getModule(NameHider.class) != null && UwU.INSTANCE.getModuleManager().getModule(NameHider.class).isEnabled()) {
           // text = UwU.INSTANCE.getModuleManager().getModule(NameHider.class).getFakeName(text);
      //  }
