                ...
                switch (INSTANCE.getModuleManager().getModule(Interface.class).notificationMode.get()) {
                    ...
                    case "Exhi": {
                        ...
                        if (!shader) {
                            ...
                            RenderUtils.drawImage(new ResourceLocation("uwu client/texture/noti/" + notification.getNotificationType().getName() + ".png"), (float) translate.getX() + 2f, (float) translate.getY() + 4.5f, 18, 18);
                    ...
                    case "Type 5": {
                        if (!shader) {
                            ...
                            RenderUtils.drawImage(new ResourceLocation("uwu client/texture/noti/" + notification.getNotificationType().getName() + ".png"), x + 3.5f, y + 3, 16, 16);
