...
package wtf.uwu.gui.click.neverlose.components;
...
import wtf.uwu.gui.click.neverlose.components.espelements.BoxElement;
import wtf.uwu.gui.click.neverlose.components.espelements.HealthElement;
import wtf.uwu.gui.click.neverlose.components.espelements.NameElement;
...
public class ESPPreviewComponent extends Component implements InstanceAccess {
    ...
    private final List<Value> values = UwU.INSTANCE.getModuleManager().getModule(ESP.class).getValues();
