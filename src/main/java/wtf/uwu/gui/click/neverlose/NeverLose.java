...
package wtf.uwu.gui.click.neverlose;
...
import wtf.uwu.features.modules.impl.visual.ESP;
import wtf.uwu.features.modules.impl.visual.Interface;
import wtf.uwu.gui.click.neverlose.panel.Panel;
import wtf.uwu.gui.click.neverlose.components.ESPPreviewComponent;
import wtf.uwu.gui.click.neverlose.panel.config.ConfigPanel;
import wtf.uwu.gui.click.neverlose.panel.search.SearchPanel;
...
public class NeverLose extends GuiScreen {
    ...
    public NeverLose() {
        Arrays.stream(ModuleCategory.values()).filter(moduleCategory -> !(moduleCategory == ModuleCategory.Config || moduleCategory == ModuleCategory.Search))
              ...
              .add(new wtf.uwu.gui.click.neverlose.panel.Panel(moduleCategory)));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        //blur
        //UwU.INSTANCE.getModuleManager().getModule(PostProcessing.class).blurScreen();
        //bg
        ...
        //title
        Fonts.interBold.get(36).drawCenteredStringWithOutline(UwU.INSTANCE.getModuleManager().getModule(Interface.class).clientName.getText(),posX + 65,posY + 12,textRGB,outlineTextRGB);
        //user info
        ...
        for (Panel panel : panels) {
            ...
            if (panel.getCategory() != ModuleCategory.Search) {
                ...
                if (panel.isSelected()) {
                    ...
                    if (panel.getCategory() == ModuleCategory.Visual && UwU.INSTANCE.getModuleManager().getModule(ESP.class).isEnabled()) {
    ...
    public void stuffToBlur(){
        ...
        if (panels.get(6).isSelected() && UwU.INSTANCE.getModuleManager().getModule(ESP.class).isEnabled()) {
