    ...
    protected void drawLines() {
        ...
        for (GroupLine<T> line : this.lines) {
            ...
            if (text != null) {
                ...
                // Enhanced text color for better visibility over animated background
                Color textColor = isAnimatedBackgroundEnabled() ?
                        new Color(220, 220, 220) : new Color(198, 198, 198);

                this.lineFontRenderer
                        .drawString(text, this.xPosition + 6, this.yPosition + yOffset, textColor.getRGB());
            }
        }
    }
