...
public class BedNuker extends Module {
    ...
    public void onUpdate(UpdateEvent event){
        ...
        if (UwU.INSTANCE.getModuleManager().getModule(Scaffold.class).isEnabled() && UwU.INSTANCE.getModuleManager().getModule(Scaffold.class).data == null && mc.thePlayer.getHeldItem().getItem() instanceof ItemBlock) {
            reset(true);
            return;
        }
