...
public class TargetESP extends Module {
    ...
    private final ResourceLocation glowCircle = new ResourceLocation("uwu client/texture/targetesp/glow_circle.png");
    private final ResourceLocation rectangle = new ResourceLocation("uwu client/texture/targetesp/rectangle.png");
    private final ResourceLocation quadstapple = new ResourceLocation("uwu client/texture/targetesp/quadstapple.png");
    private final ResourceLocation trianglestapple = new ResourceLocation("uwu client/texture/targetesp/trianglestapple.png");
    private final ResourceLocation trianglestipple = new ResourceLocation("uwu client/texture/targetesp/trianglestipple.png");
