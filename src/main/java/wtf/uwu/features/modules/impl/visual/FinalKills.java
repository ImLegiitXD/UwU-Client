...
import wtf.uwu.features.modules.impl.visual.finalkills.FkCounter;

import java.awt.*;
import java.util.stream.Collectors;

import static wtf.uwu.features.modules.impl.visual.finalkills.FkCounter.MW_GAME_START_MESSAGE;
