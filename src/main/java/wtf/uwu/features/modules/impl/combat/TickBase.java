...
import wtf.uwu.events.impl.misc.TimerManipulationEvent;
import wtf.uwu.events.impl.player.MotionEvent;
import wtf.uwu.events.impl.player.MoveEvent;
...
import wtf.uwu.utils.player.SimulatedPlayer;
...
public class TickBase extends Module {
    ...
    public boolean shouldStart() {
        ...
        if (workWithBackTrack.get()) {
            ...
            // Si BackTrack está habilitado pero no implementado, usar posición normal
